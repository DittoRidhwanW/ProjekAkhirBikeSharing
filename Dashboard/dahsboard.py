...
# Load data Bike Hour
file_Hour = "D:/DBS/Bike Sharing Dataset/Dashboard/bike_hour.xlsx"
df_hour = pd.read_excel(file_Hour)

# Load data Bike Day
file_Day = "D:/DBS/Bike Sharing Dataset/Dashboard/bike_day.xlsx"
...
if menu == "Pengaruh Musim":
    ...
    # Pastikan data yang akan divisualisasikan tidak kosong
